...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/EVEOETEAM/Files_CHOST/main/File_Bot/commands.lua") 
...
Namot = (database:get(bot_id..'Name:Bot') or 'ايفو')
...
if DevEVEOEW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/EVEOETEAM/Files_CHOST/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/EVEOETEAM/Files_CHOST/main/File_Bot/"..file)
if res == 200 then
